...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ⓇDX] %s \x1b[1;95m  Your Active Apps      :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[ⓇDX] %s \x1b[1;95m  Your Expired Apps     :{WHITE}'%(M))
        for i in range(len(game)):
...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38m ⓇDX\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> ⓇDX    .   ║  \033[1;97m
╠══[Github:=======================> \33[1;38mⓇDX          ║\33[1;34m
